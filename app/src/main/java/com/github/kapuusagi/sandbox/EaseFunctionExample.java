...
/**
 * 3つのボールがスタート操作により動くデモだけれど、何のデモなのか意味不明。
 *
 * よくわからないが、IEaseFunction により、Spriteの動作を制御するたようだ。
 *
 */
        ...
        this.runOnUpdateThread(new Runnable() {
            ...
            public void run() {
                ...
                for(int i = 0; i < 3; i++) {
                    ...
                    face.registerEntityModifier(new MoveModifier(3,
                            0, CAMERA_WIDTH - face.getWidth(),
                            y, y, currentEaseFunctionsSet[i]));
                }
            }
        });
    }
