...
/**
 * よくわからないサンプル。
 * テキストメニューということだが、反応が無かった。
 *
 * どうやら KEYCODE_MENU のボタン入力を受け取ってメニューを表示するような仕組みを実現するもののようだ。
 */
public class TextMenuExample extends SimpleBaseGameActivity implements MenuScene.IOnMenuItemClickListener {
    // ===========================================================
    // Constants
    // ===========================================================
    ...
    public void onCreateResources() {
        ...
        final ITexture fontTexture = new BitmapTextureAtlas(this.getTextureManager(),
                256, 256, TextureOptions.BILINEAR);
        this.mFont = FontFactory.createFromAsset(this.getFontManager(), fontTexture, this.getAssets(),
                "Plok.ttf", 48, true, android.graphics.Color.WHITE);
        this.mFont.load();
        ...
        this.mFaceTextureRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(
                this.mBitmapTextureAtlas, this, "face_box_menu.png",
                0, 0);
    ...
    public Scene onCreateScene() {
        ...
        face.registerEntityModifier(new MoveModifier(30,
                0, CAMERA_WIDTH - face.getWidth(),
