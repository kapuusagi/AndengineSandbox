...
import com.github.kapuusagi.sandbox.spritesheets.TexturePackerExampleSpritesheet;
    ...
    public void onCreateResources() {
        try {
            final TexturePack spritesheetTexturePack
                    = new TexturePackLoader(getAssets(), getTextureManager()).loadFromAsset("spritesheets/","texturepackerexample.xml");
