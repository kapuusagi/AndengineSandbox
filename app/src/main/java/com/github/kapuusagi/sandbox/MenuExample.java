...
public class MenuExample extends SimpleBaseGameActivity implements IOnMenuItemClickListener {
    ...
    protected void createMenuScene() {
        ...
        resetMenuItem.setBlendFunction(GLES10.GL_SRC_ALPHA, GLES10.GL_ONE_MINUS_SRC_ALPHA);
        ...
        quitMenuItem.setBlendFunction(GLES10.GL_SRC_ALPHA, GLES10.GL_ONE_MINUS_SRC_ALPHA);
