...
/**
 * TickerTextは、よくあるライトノベルなどで使うような、
 * 1文字ずつ表示するようなテキストクラスである。
 */
public class TickerTextExample extends SimpleBaseGameActivity {
    ...
    public Scene onCreateScene() {
        ...
        final Text text = new TickerText(30, 60, this.mFont,
        ...
        text.setBlendFunction(GLES10.GL_SRC_ALPHA, GLES10.GL_ONE_MINUS_SRC_ALPHA);
