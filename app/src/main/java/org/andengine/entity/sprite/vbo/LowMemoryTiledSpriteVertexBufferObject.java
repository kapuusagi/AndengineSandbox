	...
	public void onUpdateTextureCoordinates(final TiledSprite pTiledSprite) {
		...
		for (int i = 0; i < tileCount; i++) {
			...
			if (textureRegion.isRotated()) {
				bufferData.put(bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u);
				bufferData.put(bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v);

				bufferData.put(bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u2);
				bufferData.put(bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v);

				bufferData.put(bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u);
				bufferData.put(bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v2);

				bufferData.put(bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u);
				bufferData.put(bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v2);

				bufferData.put(bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u2);
				bufferData.put(bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v);

				bufferData.put(bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u2);
				bufferData.put(bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v2);
			} else {
				bufferData.put(bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u);
				bufferData.put(bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v2);

				bufferData.put(bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u);
				bufferData.put(bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v);

				bufferData.put(bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u2);
				bufferData.put(bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v2);

				bufferData.put(bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u2);
				bufferData.put(bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v2);

				bufferData.put(bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u);
				bufferData.put(bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v);

				bufferData.put(bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U, u2);
				bufferData.put(bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V, v);
			}
