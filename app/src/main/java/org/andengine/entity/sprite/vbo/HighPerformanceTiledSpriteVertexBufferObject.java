	...
	public void onUpdateTextureCoordinates(final TiledSprite pTiledSprite) {
		...
		for (int i = 0; i < tileCount; i++) {
			...
			if (textureRegion.isRotated()) {
				bufferData[bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u;
				bufferData[bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v;

				bufferData[bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u2;
				bufferData[bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v;

				bufferData[bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u;
				bufferData[bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v2;

				bufferData[bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u;
				bufferData[bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v2;

				bufferData[bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u2;
				bufferData[bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v;

				bufferData[bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u2;
				bufferData[bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v2;
			} else {
				bufferData[bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u;
				bufferData[bufferDataOffset + 0 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v2;

				bufferData[bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u;
				bufferData[bufferDataOffset + 1 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v;

				bufferData[bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u2;
				bufferData[bufferDataOffset + 2 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v2;

				bufferData[bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u2;
				bufferData[bufferDataOffset + 3 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v2;

				bufferData[bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u;
				bufferData[bufferDataOffset + 4 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v;

				bufferData[bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_U] = u2;
				bufferData[bufferDataOffset + 5 * TiledSprite.VERTEX_SIZE + Sprite.TEXTURE_COORDINATES_INDEX_V] = v;
			}
